...
public class BlogServiceImpl implements BlogService{
	...
	@Override
	public ValidationAspect.Blog readBlog(String userId, String blogUserId) throws AccessDeniedExeption, NetworkException {
        // TODO Auto-generated method stub

            System.out.println("In the Read Blog Method");
	...
	public void shareBlog(String userId, String blogUserId, String targetUserId)
        ...
        System.out.println("In the ShareBlog Method");
